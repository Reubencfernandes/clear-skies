...
const Error = () => {
  ...
  return (
    ...
    <p className="tracking-wide text-7xl text-rose-500 font-semibold font-bebas ">404</p>
        <p className="text-4xl text-slate-800 font-bold p-1">Page Not Found</p>
        <p className="mt-2 text-slate-500">Couldnt find the page you were looking for</p>
