...
const Info = (props) => {
  return (
    <div className="bg-[#1E1E1E] text-white rounded-3xl m-4 grid grid-cols-2 p-3 text-center">
      <div className='py-4'>
        <h1 className='font-bebas text-5xl'>{props.visibility}</h1>
        <p className='font-body text-xl'>Visibility</p>
      </div>

      <div className='py-4'>
        <h1 className='font-bebas text-5xl'>{props.windspeed}</h1>
      ...
      <div className='py-4'>
        <h1 className='font-bebas text-5xl'>{props.pressure}</h1>
